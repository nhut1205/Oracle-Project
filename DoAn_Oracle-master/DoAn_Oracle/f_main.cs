    ...
    public partial class f_main : Form
    {
        ...
        private string GetQuyenForCurrentUser()
        {
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                ...
                {
                    command.Parameters.Add(new OracleParameter("TenTaiKhoan", tenTaiKhoan));
        ...
        private void iconButtonThongTinNV_Click_1(object sender, EventArgs e)
        {
            KichHoatButton(sender, RGBColors.color6);
            OpenChildForm(new ThongTinTaiKhoan(tenTaiKhoan));
        }

        private void iconButtonDangXuat_Click_1(object sender, EventArgs e)
        {
            KichHoatButton(sender, RGBColors.color1);
            this.Close();
        }

        private void iconButtonSanPham_Click_1(object sender, EventArgs e)
        {
            KichHoatButton(sender, RGBColors.color2);
            OpenChildForm(new GDSanPham());
        }

        private void iconButtonTrangChu_Click_1(object sender, EventArgs e)
        {
            KichHoatButton(sender, RGBColors.color1);
            if (currentChildForm != null)
            {
        ...
        private void iconButtonBanHang_Click_1(object sender, EventArgs e)
        {
            KichHoatButton(sender, RGBColors.color3);
            OpenChildForm(new GD_Kho(tenTaiKhoan));
        }

        private void iconButtonBaoCao_Click_1(object sender, EventArgs e)
        {
            KichHoatButton(sender, RGBColors.color4);
            OpenChildForm(new GD_BaoCao());
        }
