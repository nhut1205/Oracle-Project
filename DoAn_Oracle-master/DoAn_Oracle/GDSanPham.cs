    ...
    public partial class GDSanPham : Form
    {
        ...
        private void buttonXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    OracleCommand checkProductInOrdersCommand = new OracleCommand(checkProductInOrdersQuery, connection);
                    //checkProductInOrdersCommand.Parameters.AddWithValue("@ProductId", productIdToDelete);
                    checkProductInOrdersCommand.Parameters.Add(new OracleParameter("ProductId", productIdToDelete));

                    decimal countDecimal = (decimal)checkProductInOrdersCommand.ExecuteScalar();
                    orderCount = Convert.ToInt32(countDecimal);
                    connection.Close();
                }
            }
            catch (Exception ex)
